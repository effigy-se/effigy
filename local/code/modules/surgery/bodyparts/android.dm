...
/obj/item/bodypart/head/robot/synth/get_limb_icon(dropped, mob/living/carbon/update_on)
	. = ..()
	// emissive handling
...
/obj/item/bodypart/chest/robot/synth/Initialize(mapload)
	. = ..()
	name = "[GLOB.frame_type_names[limb_id]] [parse_zone(body_zone)]"
...
/obj/item/bodypart/arm/right/robot/synth/Initialize(mapload)
	. = ..()
	name = "[GLOB.frame_type_names[limb_id]] [parse_zone(body_zone)]"
...
/obj/item/bodypart/arm/left/robot/synth/Initialize(mapload)
	. = ..()
	name = "[GLOB.frame_type_names[limb_id]] [parse_zone(body_zone)]"
...
/obj/item/bodypart/leg/right/robot/synth/Initialize(mapload)
	. = ..()
	name = "[GLOB.frame_type_names[limb_id]] [parse_zone(body_zone)]"
...
/obj/item/bodypart/leg/left/robot/synth/Initialize(mapload)
	. = ..()
	name = "[GLOB.frame_type_names[limb_id]] [parse_zone(body_zone)]"
...
// Zhenkov-Light
/obj/item/bodypart/leg/right/robot/synth/zhenkov
...
/obj/item/bodypart/leg/left/robot/synth/zhenkov
	should_draw_greyscale = FALSE
	icon_static = BODYPART_ICON_SYNTH_BASE
	icon = BODYPART_ICON_SYNTH_BASE
	icon_greyscale = BODYPART_ICON_SYNTH_BASE
...
// Zhenkov-Dark
/obj/item/bodypart/leg/right/robot/synth/zhenkovdark
	should_draw_greyscale = FALSE
	icon_static = BODYPART_ICON_SYNTH_BASE
	icon = BODYPART_ICON_SYNTH_BASE
	icon_greyscale = BODYPART_ICON_SYNTH_BASE
...
/obj/item/bodypart/leg/left/robot/synth/zhenkovdark
	should_draw_greyscale = FALSE
	icon_static = BODYPART_ICON_SYNTH_BASE
	icon = BODYPART_ICON_SYNTH_BASE
	icon_greyscale = BODYPART_ICON_SYNTH_BASE
...
// Shard Alpha
/obj/item/bodypart/leg/right/robot/synth/shard_alpha
	should_draw_greyscale = FALSE
	icon_static = BODYPART_ICON_SYNTH_BASE
	icon = BODYPART_ICON_SYNTH_BASE
	icon_greyscale = BODYPART_ICON_SYNTH_BASE
...
/obj/item/bodypart/leg/left/robot/synth/shard_alpha
	should_draw_greyscale = FALSE
	icon_static = BODYPART_ICON_SYNTH_BASE
	icon = BODYPART_ICON_SYNTH_BASE
	icon_greyscale = BODYPART_ICON_SYNTH_BASE
