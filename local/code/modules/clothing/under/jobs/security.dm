// Anything in security.dmi should be in security_digi.dmi
/obj/item/clothing/under/rank/security
	...
	bodyshape_icon_files = list(
		BODYSHAPE_HUMANOID_T = 'local/icons/mob/clothing/under/security.dmi',
		BODYSHAPE_DIGITIGRADE_T = 'local/icons/mob/clothing/under/security_digi.dmi',
	)
