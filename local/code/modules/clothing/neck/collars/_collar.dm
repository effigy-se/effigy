...
/obj/item/clothing/neck/collar/Initialize(mapload)
	...
	// Now add our examine hint about the locking functionality.
	AddElement(/datum/element/unique_examine, \
		desc = "Advances in the local scene have led to no standardized key fitting this - only one matching it's \
				exact cryptographic signature will successfully unlock [src]. [span_warning("Alternatively, you could \
				break the lock with a screwdriver...")]", \
