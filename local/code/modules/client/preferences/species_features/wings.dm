...
/datum/bodypart_overlay/mutant/wings/more/color_image(image/overlay, obj/item/bodypart/limb, layer_index)
	if(limb == null)
		return ..()
	if(limb.owner == null)
		return ..()
...
/datum/bodypart_overlay/mutant/wings/moth/color_image(image/overlay, obj/item/bodypart/limb, layer_index)
	if(limb == null)
		return ..()
	if(limb.owner == null)
		return ..()
