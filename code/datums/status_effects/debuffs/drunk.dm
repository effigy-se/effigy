...
/datum/status_effect/inebriated/tick(seconds_between_ticks)
	...
	set_drunk_value(drunk_value - (drunk_value * 0.0015)) // EffigyEdit Change - Alcohol Processing - Original: drunk_value - (0.01 + drunk_value * 0.04))
	if(QDELETED(src))
		return
...
/datum/status_effect/inebriated/drunk/on_tick_effects()
	...
	// EffigyEdit Change - Alcohol Processing - Original:
	/*
...
/datum/status_effect/inebriated/drunk/proc/attempt_to_blackout()
	/* // EffigyEdit Change Remove - Alcohol Processing
