...
/datum/status_effect/grouped/stasis/on_apply()
	...
	if(!.)
		return
	owner.add_traits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED, TRAIT_STASIS, TRAIT_TUMOR_SUPPRESSED, TRAIT_ANALGESIA), TRAIT_STATUS_EFFECT(id)) // EffigyEdit Change - Enhanced Surgery - Add TRAIT_ANALGESIA
...
/datum/status_effect/grouped/stasis/on_remove()
	owner.remove_traits(list(TRAIT_IMMOBILIZED, TRAIT_HANDS_BLOCKED, TRAIT_STASIS, TRAIT_TUMOR_SUPPRESSED, TRAIT_ANALGESIA), TRAIT_STATUS_EFFECT(id)) // EffigyEdit Change - Enhanced Surgery - Add TRAIT_ANALGESIA
