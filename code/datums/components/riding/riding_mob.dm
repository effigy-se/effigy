	...
	*//// EFFIGY EDIT END
	...
	if(seat.buckle_lying)
		return HAS_TRAIT(seat, TRAIT_OVERSIZED) ? list(
				...
				TEXT_SOUTH = list(0, OVERSIZED_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_EAST = list(0, OVERSIZED_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_WEST = list(0, OVERSIZED_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
			) : list(
				TEXT_NORTH = list(0, REGULAR_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_SOUTH = list(0, REGULAR_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_EAST = list(0, REGULAR_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_WEST = list(0, REGULAR_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
			)
	else
		return HAS_TRAIT(seat, TRAIT_OVERSIZED) ? list(
				TEXT_NORTH = list(0, OVERSIZED_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_SOUTH = list(0, OVERSIZED_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_EAST = list(-OVERSIZED_SIDE_OFFSET, OVERSIZED_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_WEST = list(OVERSIZED_SIDE_OFFSET, OVERSIZED_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
			) : list(
				TEXT_NORTH = list(0, REGULAR_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_SOUTH = list(0, REGULAR_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_EAST = list(-REGULAR_OFFSET, REGULAR_SIDE_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER),
				TEXT_WEST = list(REGULAR_OFFSET, REGULAR_SIDE_OFFSET, MOB_ABOVE_PIGGYBACK_LAYER)
			)
