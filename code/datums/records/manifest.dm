...
/datum/manifest/proc/inject(mob/living/carbon/human/person, atom/appearance_proxy, client/player_client) // EffigyEdit Add - Character Preferences - add player_client
	set waitfor = FALSE
