...
/datum/bodypart_overlay/mutant/proc/build_icon_state(image_layer, obj/item/bodypart/limb)
	...
	return "[gender_key]_[feature_key_sprite ? feature_key_sprite : feature_key]_[base_state]_[layer_key]" // EffigyEdit Change - Character Preferences - Add feature_key_sprite
