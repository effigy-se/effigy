/obj/item/bodypart/head/moth
	...
	teeth_count = 0
	//bodypart_traits = list(TRAIT_ANTENNAE) // EffigyEdit Remove - Character Preferences
...
/obj/item/bodypart/chest/moth
	...
	//bodypart_traits = list(TRAIT_TACKLING_WINGED_ATTACKER) // EffigyEdit Remove - Character Preferences
