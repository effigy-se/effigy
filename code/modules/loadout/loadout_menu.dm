...
/* EffigyEdit Remove - Custom Loadouts - Moved to local/code/modules/loadout/loadout_menu.dm
...
/datum/preference_middleware/loadout/proc/select_item(datum/loadout_item/selected_item)
	var/list/loadout = get_current_loadout() // EffigyEdit Change - Custom Loadouts - Original: preferences.read_preference(/datum/preference/loadout)
	...
	save_current_loadout(loadout) // EffigyEdit Change - Custom Loadouts - Original: preferences.update_preference(GLOB.preference_entries[/datum/preference/loadout], loadout)
