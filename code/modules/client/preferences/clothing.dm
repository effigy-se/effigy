/proc/generate_underwear_icon(datum/sprite_accessory/accessory, datum/universal_icon/base_icon, color, icon_offset = 0) // EffigyEdit Change - Character Preferences - add icon_offset
	...
	if (!isnull(accessory))
		var/datum/universal_icon/accessory_icon = uni_icon(accessory.icon, accessory.icon_state) // EffigyEdit Change - Character Preferences - Original: uni_icon('icons/mob/clothing/underwear.dmi', accessory.icon_state)
...
/datum/preference/choiced/socks/icon_for(value)
	...
	return generate_underwear_icon(SSaccessories.socks_list[value], lower_half) // EffigyEdit Change - Character Preferences - Original: generate_underwear_icon
...
/datum/preference/choiced/undershirt/icon_for(value)
	...
	if (value != "Nude")
		...
		icon_with_undershirt.blend_icon(uni_icon(accessory.icon, accessory.icon_state), ICON_OVERLAY) // EffigyEdit Change - Character Preferences - Original: icon_with_undershirt.blend_icon(uni_icon('icons/mob/clothing/underwear.dmi', accessory.icon_state), ICON_OVERLAY)
