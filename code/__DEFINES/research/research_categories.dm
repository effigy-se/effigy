...
#define RND_CATEGORY_CIRCUITRY_SHELLS "/Circuit Shells"
#define RND_CATEGORY_CIRCUITRY_COMPS "/Circuit Components"
	#define RND_SUBCATEGORY_CIRCUITRY_ACTION_COMPONENTS "/Action"
	#define RND_SUBCATEGORY_CIRCUITRY_BCI_COMPONENTS "/BCI"
	#define RND_SUBCATEGORY_CIRCUITRY_ENTITY_COMPONENTS "/Entity"
	#define RND_SUBCATEGORY_CIRCUITRY_ID_COMPONENTS "/ID Access"
	#define RND_SUBCATEGORY_CIRCUITRY_LIST_COMPONENTS "/List"
	#define RND_SUBCATEGORY_CIRCUITRY_MATH_COMPONENTS "/Mathematics"
	#define RND_SUBGATEGORY_CIRCUITRY_COMM_COMPONENTS "/Communication"
	#define RND_SUBCATEGORY_CIRCUITRY_SENSOR_COMPONENTS "/Sensor"
	#define RND_SUBCATEGORY_CIRCUITRY_STRING_COMPONENTS "/String"
	#define RND_SUBCATEGORY_CIRCUITRY_UTILITY_COMPONENTS "/Utility"
