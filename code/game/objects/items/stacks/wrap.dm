...
/obj/item/stack/wrapping_paper/click_alt(mob/user)
	var/new_base = tgui_color_picker(user, "", "Select a base color", color) // EffigyEdit Change - TGUI Color Picker
	var/new_ribbon = tgui_color_picker(user, "", "Select a ribbon color", color) // EffigyEdit Change - TGUI Color Picker
