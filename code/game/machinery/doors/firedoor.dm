...
/obj/machinery/door/firedoor/proc/unregister_adjacent_turfs(atom/old_loc)
	...
	UnregisterSignal(our_turf, COMSIG_TURF_LIQUIDS_CHANGE) // EffigyEdit Add - Liquids
	for(var/dir in GLOB.cardinals)
		var/turf/checked_turf = get_step(our_turf, dir)
		...
		UnregisterSignal(checked_turf, COMSIG_TURF_LIQUIDS_CHANGE) // EffigyEdit Add - Liquids
