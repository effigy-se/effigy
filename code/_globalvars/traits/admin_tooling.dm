...
GLOBAL_LIST_INIT(admin_visible_traits, list(
	...
	/mob = list(
		...
		"TRAIT_OVERSIZED" = TRAIT_OVERSIZED, // EFFIGY EDIT ADD - TRAITS
		...
		"TRAIT_SENSITIVESNOUT" = TRAIT_SENSITIVESNOUT, // EffigyEdit Addition
		...
		"TRAIT_SYNTH_CHARGING" = TRAIT_SYNTH_CHARGING, // EffigyEdit Add - Synths
