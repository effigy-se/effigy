...
DEFINE_BITFIELD(chemical_flags, list(
	...
	"REAGENT_NEUROWARE_PACKAGE" = REAGENT_NEUROWARE_PACKAGE, // EffigyEdit Add - Synths
))
...
DEFINE_BITFIELD(allow_custom_character, list(
	"GHOSTROLE_ALLOW_SPECIES" = GHOSTROLE_ALLOW_SPECIES,
	"GHOSTROLE_ALLOW_OTHER" = GHOSTROLE_ALLOW_OTHER,
))
